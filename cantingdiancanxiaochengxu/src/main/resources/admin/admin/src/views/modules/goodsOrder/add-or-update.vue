    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="餐桌" prop="canzhuoTypes">
                        <el-select v-model="ruleForm.canzhuoTypes" :disabled="ro.canzhuoTypes" placeholder="请选择餐桌">
                            <el-option
                                v-for="(item,index) in canzhuoTypesOptions"
                    ...
                    <div v-else>
                        <el-form-item class="input" label="餐桌" prop="canzhuoValue">
                        <el-input v-model="ruleForm.canzhuoValue"
...
<script>
    ...
    export default {
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=canzhuo_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.canzhuoTypesOptions = data.data.list;
                    }
                });
                this.$http({
