    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="总销量" prop="shangxiaXiaoliang">
                       <el-input v-model="ruleForm.shangxiaXiaoliang"
                                 placeholder="总销量" clearable  :readonly="ro.shangxiaXiaoliang"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="总销量" prop="shangxiaXiaoliang">
                           <el-input v-model="ruleForm.shangxiaXiaoliang"
                                     placeholder="总销量" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="24">
