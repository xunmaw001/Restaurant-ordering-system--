<template>
  <div>
    ...
    >  
     <el-row>
                    <el-col :span="12">
           <el-form-item v-if="flag=='houchu'"  label='后厨姓名' prop="houchuName">
               <el-input v-model="ruleForm.houchuName"  placeholder='后厨姓名' clearable></el-input>
           </el-form-item>
         </el-col>

         <el-col :span="12">
           <el-form-item v-if="flag=='houchu'"  label='身份证号' prop="houchuIdNumber">
               <el-input v-model="ruleForm.houchuIdNumber"  placeholder='身份证号' clearable></el-input>
           </el-form-item>
         </el-col>

         <el-col :span="12">
           <el-form-item v-if="flag=='houchu'"  label='手机号' prop="houchuPhone">
               <el-input v-model="ruleForm.houchuPhone"  placeholder='手机号' clearable></el-input>
           </el-form-item>
         </el-col>

         <el-col :span="12">
             <el-form-item v-if="flag=='houchu'" label='照片' prop="houchuPhoto">
                 <file-upload
                         tip="点击上传照片"
                         action="file/upload"
                         :limit="3"
...
export default {
  ...
  methods: {
    ...
    onUpdateHandler() {
                         if((!this.ruleForm.houchuName)&& 'houchu'==this.flag){
                             this.$message.error('后厨姓名不能为空');
                             return
                         }

                         if((!this.ruleForm.houchuIdNumber)&& 'houchu'==this.flag){
                             this.$message.error('身份证号不能为空');
                             return
                         }

                             if( 'houchu' ==this.flag && this.ruleForm.houchuPhone&&(!isMobile(this.ruleForm.houchuPhone))){
                                 this.$message.error(`手机应输入手机格式`);
                                 return
                             }
                         if((!this.ruleForm.houchuPhoto)&& 'houchu'==this.flag){
