...
import center from '@/views/center'
    ...
    import houchu from '@/views/modules/houchu/list'
    ...
    import dictionaryCanzhuo from '@/views/modules/dictionaryCanzhuo/list'
...
const routes = [{
    ...
    ,{
        path: '/dictionaryCanzhuo',
        name: '餐桌',
        component: dictionaryCanzhuo
    }
    ,{
