...
//                            goodsOrderEntity.setCanzhuoTypes(Integer.valueOf(data.get(0)));   //餐桌 要改的
...
//                            goodsOrderEntity.setCreateTime(date);//时间
    ...
    */
    ...
    public R add(@RequestParam Map<String, Object> params, HttpServletRequest request){
        ...
        Integer canzhuoTypes = Integer.valueOf(String.valueOf(params.get("canzhuoTypes")));//餐桌
        ...
        for (Map<String, Object> map : goodss) {
           //取值
            ...
            //商品销量添加1
            goodsEntity.setShangxiaXiaoliang(goodsEntity.getShangxiaXiaoliang()+buyNumber);
            ...
            goodsOrderEntity.setCanzhuoTypes(canzhuoTypes);//餐桌 ？？？？？？
