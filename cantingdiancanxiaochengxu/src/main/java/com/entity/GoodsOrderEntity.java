...
public class GoodsOrderEntity<T> implements Serializable {
     ...
     * 餐桌
     */
    @TableField(value = "canzhuo_types")

    private Integer canzhuoTypes;
	 ...
	 * 设置：餐桌
	 */
    public Integer getCanzhuoTypes() {
        return canzhuoTypes;
    }
    ...
    public void setCanzhuoTypes(Integer canzhuoTypes) {
        this.canzhuoTypes = canzhuoTypes;
    }
    /**
	 * 设置：购买的数量
	 */
