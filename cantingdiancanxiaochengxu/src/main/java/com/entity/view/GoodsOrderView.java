...
public class GoodsOrderView extends GoodsOrderEntity implements Serializable {
    private static final long serialVersionUID = 1L;
		...
		*/
		...
		//级联表 goods
			...
			* 总销量
			*/
			private Integer shangxiaXiaoliang;
			/**
			* 逻辑删除
			*/
	...
	public GoodsOrderView(GoodsOrderEntity goodsOrderEntity) {
		try {
			...
			* 获取： 餐桌的值
			*/
			public String getCanzhuoValue() {
				return canzhuoValue;
			}
			/**
			* 设置： 餐桌的值
			*/
			public void setCanzhuoValue(String canzhuoValue) {
				this.canzhuoValue = canzhuoValue;
			}
			/**
			* 获取： 订单类型的值
			*/
			...
			*/
			public void setGoodsOrderPaymentValue(String goodsOrderPaymentValue) {
				...
				//级联表的get和set goods
					...
					* 获取： 总销量
					*/
					public Integer getShangxiaXiaoliang() {
						return shangxiaXiaoliang;
					}
					/**
					* 设置： 总销量
					*/
					public void setShangxiaXiaoliang(Integer shangxiaXiaoliang) {
						this.shangxiaXiaoliang = shangxiaXiaoliang;
					}
					/**
					* 获取： 逻辑删除
					*/
